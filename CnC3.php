...
// selecting information for Harbor Freight
$shopQ = "SELECT * FROM shops WHERE id = 4";
$shopR = $conn->query($shopQ);
// selecting all products where stock is available
$s3Query = "SELECT * FROM shop3products WHERE quantity > 0";
$s3Result = $conn->query($s3Query);

// using while loop to fetch information for Harbor Freight
...
<body>
    ...
    <main class="container container1">
        ...
        if (isset($_POST['CnC3'])) {
            ...
            $s3Query2 = "SELECT * FROM shop3products WHERE product_id = $product";
            $s3Result2 = $conn->query($s3Query2);
            while ($row2 = $s3Result2->fetch_assoc()) {
                $price = $row2['price'];
            ...
            if ($quantity > $quantity1) {
                ...
                if (isset($_SESSION['user_40180801'])) {
                    ...
                    $sql = "INSERT INTO orders (first_name, last_name, email_address, phone_number, product_id, quantity, total, shop_id) VALUES ('$firstName', '$lastName', '$emailAddress', '$phoneNumber', '$product', '$quantity', '$total', 4)";

                    $sql2 = "UPDATE `shop3products` SET `quantity`=GREATEST(0, `quantity`-$quantity) WHERE `product_id` = $product";
                    ...
                    $sql = "INSERT INTO orders (first_name, last_name, email_address, phone_number, product_id, quantity, total, shop_id) VALUES ('$firstName', '$lastName', '$emailAddress', '$phoneNumber', '$product', '$quantity', '$total2', 4)";
        ...
        <div class="row">
            ...
            // shop information for Harbor Freight with embedded map of location of shop
                ...
                <div class='card'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-8 mb-3'>
                            <div class='d-flex flex-column align-items-center text-center'>
                            <br>
                            <iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2311.6897653411625!2d-5.966139484114233!3d54.59184038025886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48610887ca97ecc5%3A0x254761de5b331941!2s269%20Falls%20Rd%2C%20Belfast%20BT12%206FD!5e0!3m2!1sen!2suk!4v1612798311026!5m2!1sen!2suk' width='300' height='300' frameborder='0' style='border:0;' allowfullscreen='' aria-hidden='false' tabindex='0'></iframe>
                            </div>
                        </div>
                        </div>
                    </div>
        ...
        <!-- click and collect form -->
            <div class="click_collect_card">
                ...
                <div class="d-flex justify-content-center form_container">
                    <form action="CnC3.php" method="post">
                        <!-- first name -->
                        ...
                        <div class="d-flex justify-content-center mt-3 login_container">
                            <button type="submit" name="CnC3" id="CnC3" class="btn login_btn">Click & Collect</button>
                        </div>
                    </form>
                </div>
            </div>
