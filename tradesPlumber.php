...
$productQuery = "SELECT * FROM products WHERE trade_id = 2";
...
<body>
    ...
    <main class="container container1">
        <div class="products-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-left">
            <h1 class="display-4">Plumbing:</h1>
            <h5>Have a look at all the products that are suitable for plumbing</h5>
        </div>
 ...
 ?>
        ...
        <div class="products-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-left">
            <h1 class="display-5">Looking for a Plumber?</h1>
            <p></p>
