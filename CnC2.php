...
// selecting information for Home Hardware
$shopQ = "SELECT * FROM shops WHERE id = 3";
$shopR = $conn->query($shopQ);
// selecting all products where stock is available
$s2Query = "SELECT * FROM shop2products WHERE quantity > 0";
$s2Result = $conn->query($s2Query);

// using while loop to fetch information for Home Hardware
...
<body>
    ...
    <main class="container container1">
        ...
        if (isset($_POST['CnC2'])) {
            ...
            $s2Query2 = "SELECT * FROM shop2products WHERE product_id = $product";
            $s2Result2 = $conn->query($s2Query2);
            while ($row2 = $s2Result2->fetch_assoc()) {
                $price = $row2['price'];
            ...
            if ($quantity > $quantity1) {
                ...
                if (isset($_SESSION['user_40180801'])) {
                    ...
                    $sql = "INSERT INTO orders (first_name, last_name, email_address, phone_number, product_id, quantity, total, shop_id) VALUES ('$firstName', '$lastName', '$emailAddress', '$phoneNumber', '$product', '$quantity', '$total', 3)";

                    $sql2 = "UPDATE `shop2products` SET `quantity`=GREATEST(0, `quantity`-$quantity) WHERE `product_id` = $product";
                    ...
                    $sql = "INSERT INTO orders (first_name, last_name, email_address, phone_number, product_id, quantity, total, shop_id) VALUES ('$firstName', '$lastName', '$emailAddress', '$phoneNumber', '$product', '$quantity', '$total2', 3)";
        ...
        <div class="row">
            ...
            // shop information for Home Hardware with embedded map of location of shop
                ...
                <div class='card'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-8 mb-3'>
                            <div class='d-flex flex-column align-items-center text-center'>
                            <br>
                            <iframe src='https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2311.846913372601!2d-5.9645817!3d54.5890715!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48610886071f378b%3A0x10c790b29c645314!2sPark%20Centre!5e0!3m2!1sen!2suk!4v1612795952695!5m2!1sen!2suk' width='300' height='300' frameborder='0' style='border:0;' allowfullscreen='' aria-hidden='false' tabindex='0'></iframe>
                            </div>
                        </div>
                        </div>
                    </div>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="click_collect_card">
                ...
                <div class="d-flex justify-content-center form_container">
                    <form action="CnC2.php" method="post">
                        <!-- first name -->
                        ...
                        <div class="d-flex justify-content-center mt-3 login_container">
                            <button type="submit" name="CnC2" id="CnC2" class="btn login_btn">Click & Collect</button>
                        </div>
                    </form>
                </div>
            </div>
